...
- **Ticket split**, mirroring M56's: **1** the `pkg/stats` kernel + the `person`/`unit` stats endpoints
  ...
  **3** the `@visx/*` primitives, `dashboard?: ChartDef[]` and `?view=dashboard`; **4** the live
  end-to-end run.
