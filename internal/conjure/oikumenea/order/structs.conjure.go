...
func (o OrderStats) MarshalJSON() ([]byte, error) {
	if o.Facets == nil {
		o.Facets = make([]FacetDistribution, 0)
	}
	type _tmpOrderStats OrderStats
	return safejson.Marshal(_tmpOrderStats(o))
}

func (o *OrderStats) UnmarshalJSON(data []byte) error {
	type _tmpOrderStats OrderStats
	var rawOrderStats _tmpOrderStats
	if err := safejson.Unmarshal(data, &rawOrderStats); err != nil {
		return err
	}
	if rawOrderStats.Facets == nil {
		rawOrderStats.Facets = make([]FacetDistribution, 0)
	}
	*o = OrderStats(rawOrderStats)
	return nil
}

func (o OrderStats) MarshalYAML() (interface{}, error) {
	jsonBytes, err := safejson.Marshal(o)
	if err != nil {
		return nil, err
	}
...
func (o *OrderStats) UnmarshalYAML(unmarshal func(interface{}) error) error {
	jsonBytes, err := safeyaml.UnmarshalerToJSONBytes(unmarshal)
	if err != nil {
		return err
	}
