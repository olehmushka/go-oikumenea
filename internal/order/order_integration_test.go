...
import (
	...
	memadapters "github.com/olehmushka/go-oikumenea/internal/membership/adapters"
	memapp "github.com/olehmushka/go-oikumenea/internal/membership/application"
	memdomain "github.com/olehmushka/go-oikumenea/internal/membership/domain"
	orderadapters "github.com/olehmushka/go-oikumenea/internal/order/adapters"
	orderapp "github.com/olehmushka/go-oikumenea/internal/order/application"
...
func seedUnit(t *testing.T, pool *pgxpool.Pool) string {
	...
	if err := pool.QueryRow(context.Background(),
		`INSERT INTO oikumenea.tenant_units (org_id, domain_id, code, name)
		 ...
		 RETURNING id`, code(t, "unit")).Scan(&id); err != nil {
