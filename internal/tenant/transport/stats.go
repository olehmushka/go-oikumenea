...
func (s Service) UnitStats(ctx context.Context, token bearertoken.Token, org string, facets *string, query *string, domainID *string, unitKind *string, level *int, levelMin *int, levelMax *int, visibility *string, state *string, pdpScoped *bool) (tenantapi.UnitStats, error) {
