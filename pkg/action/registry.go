...
var actionTypes = []ActionType{
	...
	{Code: "person.health_record.delete", Service: rid.SvcPerson, TargetType: "person", Permission: "person.update"},
	{Code: "person.health_record.upsert", Service: rid.SvcPerson, TargetType: "person", Permission: "person.update", RequestType: "oikumenea.person.UpsertHealthRecordRequest"},
	{Code: "person.insurance.delete", Service: rid.SvcPerson, TargetType: "person", Permission: "person.update"},
	{Code: "person.insurance.upsert", Service: rid.SvcPerson, TargetType: "person", Permission: "person.update", RequestType: "oikumenea.person.UpsertInsuranceRequest"},
