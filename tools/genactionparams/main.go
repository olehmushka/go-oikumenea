...
func render(params map[string][]param) []byte {
	...
	var b bytes.Buffer
	// Emitted, not stamped afterwards — see the twin comment in tools/genactionendpoints: a
	// hand-added header that the generator does not reproduce makes regeneration non-idempotent.
